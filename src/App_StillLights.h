...
void v_AppStillsLights_Main_TLU            (LiquidCrystal_I2C   j_Lcd,          Keypad      j_Keypad,   CRGB              * paj_Leds,
                                            T_LedStrip        * pt_LedStrip,    uint8       u8Selection                                  );
void v_AppStillsLights_Gradient_TLU        (LiquidCrystal_I2C   j_Lcd,          Keypad      j_Keypad,   CRGB              * paj_Leds,
                                            T_LedStrip        * pt_LedStrip,    uint8       u8Selection                                  );
void v_AppStillLights_StillSectsChkpts     (LiquidCrystal_I2C   j_Lcd,          Keypad      j_Keypad,   CRGB              * paj_Leds,
                                            T_LedStrip        * pt_LedStrip,    uint8       u8Selection                                  );
